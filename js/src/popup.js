...
(function($) {
  ...
  narr.html('본 사이트는 어떠한 경우라도 상업 및 영리를 목적으로 제작된 페이지가 아니며, <br /> 취업을 목적으로 한 개인 포트폴리오 사이트임을 알려드립니다. <br /> 문제가 되거나, 수정을 원하신다면 메일로 연락주시면 조치를 취하도록 하겠습니다. <br /> rlagksmf0918@gmail.com <br /> 사용된 이미지의 출처는 아래 링크를 통해 확인하세요. <br /> <a tabindex="1" href="./image_link.html" target="_blank">이미지 출처 확인하기<a>');
